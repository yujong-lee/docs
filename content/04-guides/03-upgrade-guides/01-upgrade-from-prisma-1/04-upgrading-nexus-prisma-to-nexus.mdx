...
metaTitle: 'Upgrading from Prisma 1 with nexus-prisma to @nexus/schema and nexus-plugin-prisma'
metaDescription: 'Learn how to upgrade existing Prisma 1 projects with `nexus-prisma` to Prisma 2 with `@nexus/schema` and `nexus-plugin-prisma`.'
---

## Overview

<!-- > **Note**: There has been a lot of movement in the Nexus ecosystem.  -->
...
- introspected your database and resolved potential [schema incompatibilities](./schema-incompatibilities)
