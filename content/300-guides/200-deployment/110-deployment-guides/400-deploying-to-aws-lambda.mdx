...
metaDescription: 'Learn how to deploy Node.js and TypeScript applications that are using Prisma Client to AWS Lambda.'
---
...
The focus of this guide is showing how an API based on Prisma can be deployed to AWS Lambda. The starting point will be the [Prisma AWS example](https://github.com/prisma/prisma-examples/tree/latest/deployment-platforms/aws-lambda) which has a couple of REST endpoints preconfigured as serverless functions.
...
- [AWS](https://aws.amazon.com/) account and a corresponding <a href="https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_access-keys.html">access key</a> for programmatic access.
